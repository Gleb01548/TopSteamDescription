...
- [Топы стима](#топы-стима)
  ...
  - [Поиск по тэгам](#поиск-по-тэгам)


В канале [ТопСтим](https://t.me/TopSteam100) раз в день выкладывается несколько таблиц, среди которых:
...
3. игры, которые вышли из топа;
4. игры, которые в топе остались.

Указанные выше таблицы будут в дальнейшем обозначаться, как Таблицы 1-4.

Источник данных: [Чарты Steam](https://store.steampowered.com/charts/mostplayed), информация о самых популярных играх за последние 24 часа. Считывание информации происходит в 01:20 по Гринвичу (GMT).
...
**Таблица 3** таблица содержит информацию о том, какие игры вышли из топа, в сравнении с прошлым периодом..
<details>
...
**Таблица 4** содержит информацию об играх, которые в топе были в прошедшем периоде и остались в актуальном периоде.
...
Например, данные за неделю, которая начинается 01.01.2024 и длится до 07.01.2024 (включительно), рассчитается только 08.01.2024. В шапке сообщения будет указано, что период - неделя, а информация за 2024-01-01 (то есть дата, когда анализируемая неделя началась)
...
Также у скачанных с телеграм канала excel-файлов есть фильтры на каждую колонку. 
...
## Поиск по тэгам
В сообщениях в телеграмм используются тэги напротив даты и типа периода, например #2024-01-01, #день.

Если вы хотите найти:
- сообщение за определенный день, просто вбейте в поиске дату в формате #ГГГГ-ММ-ДД (не забудьте про #); 
- если хотите найти информацию за определенный период используете: #день, #неделя, #месяц, #год.
